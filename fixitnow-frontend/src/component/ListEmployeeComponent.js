...
const ListEmployeeComponent = () => {
    ...
    return (
        <div className='container'>
            <Link to={"/add-employee"} className='btn btn-primary mb-2 mt-3' href="">Add Job</Link>
            <h2 className='text-center mb-4'>Items to Fix</h2>
            <table className='table table-bordered table striped'>
                <thead>
                    <th>Job ID</th>
                    <th>Poster's Name</th>
                    <th>Job Description</th>
                    <th>Poster's Address</th>
                    <th>Actions</th>
                </thead>
                <tbody>
                    {employeeArray.map(employee =>
                        <tr id={employee.id}>
                            ...
                            <td>
                                ...
                                <a onClick={(e) => deleteEmployee(e, employee.id)} className='btn btn-danger'>Pick Job</a>
                            </td>
                        </tr>)}
